...
<section id="bio" class="pb-5">
   ...
   <div class="container">
       ...
       <div class="col-lg-6 pt-lg-5 pl-lg-5 pt-4 bioSkills">
        ...
        <div>    
           <div class="progress">
            <div class="progress-bar progress-bar-striped progress-bar-animated verde" role="progressbar" style="width: 95%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100">HTML-HTML5</div>
        </div>
    </div>
    <div>
       <div class="progress">
